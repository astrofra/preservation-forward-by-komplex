...
public final class IndexedSurface
extends SoftwareImageSurface {
    ...
    public IndexedSurface(int n, int n2, byte[] byArray, byte[] byArray2, byte[] byArray3, byte[] byArray4) {
        this(n, n2, 1, false);
        this.amaJAkk(byArray, byArray2, byArray3, byArray4);
    }

    public IndexedSurface(int n, int n2, int n3, boolean bl) {
        super(n, n2);
        this.aMAJakK = n3;
        if (this.aMAJakK == 1) {
    ...
    public final void AMaJakk(IndexedSurface kmajkka2) {
    ...
    public final void aMajakk(int var1_1) {
        ...
        System.arraycopy(IndexedSurface.amaJakK, n + 256, byArray, 128, 128);
        System.arraycopy(IndexedSurface.amaJakK, n + 384, byArray, 0, 128);
        int n2 = this.amAjakK * this.AMAjakK;
    ...
    public void AMaJAkk(IndexedSurface kmajkka2, int n, int n2) {
        this.aMAJakk(kmajkka2, n, n2, 0, 0, kmajkka2.amAjakK, kmajkka2.AMAjakK);
    }

    public void aMAJakk(IndexedSurface kmajkka2, int n, int n2, int n3, int n4, int n5, int n6) {
        if (n < 0) {
            n5 += n;
            n3 -= n;
            n = 0;
    ...
    public final void AmaJakk(RgbSurface mmaamma2, byte by) {
    ...
    static {
        ...
        while (n < 768) {
            ...
            IndexedSurface.amaJakK[n] = (byte)n3;
            ++n;
        }
    }
}
