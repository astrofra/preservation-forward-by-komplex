...
extends Scene {
    ...
    public void init(DesktopAppletBase mmjamma2) {
        this.kamAJAK = ForwardDemoApp.kAmajAk / 128;
        this.KaMAjAK(mmjamma2);
        this.KamAjAK = new SceneRenderer();
        this.kamAjAK = new Camera();
        this.kamAjAK.JakkaMa = new Vec3f(0.0f, 0.0f, 1.0f);
        ...
        while (n < this.kaMAJAK.MaJAKkA.size()) {
            MeshObject mmajmmk2 = (MeshObject)this.kaMAJAK.MaJAKkA.elementAt(n);
        ...
        if (this.KaMAJAK) {
            this.KaMaJak = IguMeshLoader.kAMaJAk(mmjamma2.amAjAkK("meshes/kluns2.igu"));
            ForwardDemoApp.kkamAJA.kAMajak();
            this.KaMaJak.jaKKaMA.mAjakKA(this.kamAjAK.JAKkaMa.MaJakKA(-0.0f, -0.0f, -20.0f));
            this.KaMaJak.JAKKaMA.MajaKka(0.45);
            this.KaMaJak.KkaMaja(mmaamma3);
    ...
    public void render(RgbSurface mmaamma2, float f, float f2) {
        ForwardDemoApp.kkAMAjA.kAMaJAK(0);
