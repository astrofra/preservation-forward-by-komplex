...
public class Mat3f {
    ...
    public Mat3f(Vec3f mmajmma2, Vec3f mmajmma3, Vec3f mmajmma4) {
        this.AmaJaKk(mmajmma2, mmajmma3, mmajmma4);
    }

    public Mat3f(Vec3f mmajmma2) {
        this.AmajaKk(mmajmma2);
    }

    public Mat3f(Mat3f maajkka2) {
    ...
    public final void AmaJaKk(Vec3f mmajmma2, Vec3f mmajmma3, Vec3f mmajmma4) {
        this.aMAjAKk(mmajmma2);
        this.amAjAKk(mmajmma3);
        this.AmAjAKk(mmajmma4);
    }

    public final void AmajaKk(Vec3f mmajmma2) {
    ...
    public final void aMAJaKk(float f, float f2, float f3) {
        ...
        mmajmma2.mAjakKA(Vec3f.MAjAKKA);
    ...
    public final void aMajaKk(Mat3f maajkka2) {
    ...
    public final void KAMaJaK(Vec3f mmajmma2) {
        mmajmma2.MaJaKka(this.AmajAKK, this.amajAKK, this.AMajAKK);
    }

    public final Vec3f kaMaJaK() {
        Vec3f mmajmma2 = new Vec3f(this.AMaJakK, this.aMaJakK, this.AmAjAKK);
        return mmajmma2;
    }
    ...
    public final Mat3f AMajaKk(float f) {
        Mat3f maajkka2 = new Mat3f(this);
        maajkka2.amajaKk(f);
        return maajkka2;
    }
    ...
    public final Vec3f AmAJaKk(Vec3f mmajmma2) {
        Vec3f mmajmma3 = new Vec3f(mmajmma2);
        this.amaJaKk(mmajmma3);
        return mmajmma3;
    }
    ...
    public final Mat3f amAJaKk(Mat3f maajkka2) {
        Mat3f maajkka3 = new Mat3f(this);
    ...
    public final Mat3f AmajAKk() {
        Mat3f maajkka2 = new Mat3f();
    ...
    public Mat3f aMaJakk() {
        Mat3f maajkka2 = new Mat3f(this);
        maajkka2.aMaJakk();
        return maajkka2;
    }

    public void AmaJAKk(Vec3f mmajmma2) {
    ...
    public Mat3f kAMaJaK(Vec3f mmajmma2) {
        Mat3f maajkka2 = new Mat3f(this);
        maajkka2.AmaJAKk(mmajmma2);
        return maajkka2;
    }

    public Mat3f AMAjaKk(Vec3f mmajmma2) {
        Mat3f maajkka2 = new Mat3f(this);
        maajkka2.aMAJAKk(mmajmma2);
        return maajkka2;
    }
