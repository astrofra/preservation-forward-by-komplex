...
extends Scene {
    ...
    public void render(RgbSurface mmaamma2, float f, float f2) {
        ...
        this.kaMaJaK.MajAKkA(this.aMaJaKk, ForwardDemoApp.kkAMAjA);
        this.kaMaJaK.MAJAKkA(ForwardDemoApp.kkAMAjA);
        if (this.kAMAJaK > 0.0f) {
            this.kAMAJaK -= this.KamAJaK * f2;
            SaariScene.KaMaJak(mmaamma2, (int)this.kAMAJaK);
        }
        if (this.kAmaJaK) {
            mmaamma2.AMaJakK(RgbSurface.aMAJAKK(255, 255, 255));
