...
public abstract class SurfacePresenter {
    ...
    public final void KkaMAjA(DesktopAppletBase mmjamma2, int n, int n2) {
        this.KKamAjA(mmjamma2, n, n2, 1);
    }

    public final void KKamAjA(DesktopAppletBase mmjamma2, int n, int n2, int n3) {
        this.kkamAjA(mmjamma2, n, n2, n3, n3);
    }

    public final void kkamAjA(DesktopAppletBase mmjamma2, int n, int n2, int n3, int n4) {
        this.AKKAmaJ = n3;
        this.aKKAmaJ = n4;
        this.AkKAmaJ = n;
        this.akKAmaJ = n2;
    ...
    public final void KKAMAjA(Graphics graphics, int n, int n2) {
        ...
        this.nextScriptTimeHex(graphics, n, n2);
    }

    public final void kKAMAjA(Triangle[] kmaammaArray, int n) {
        int n2 = 0;
        while (n2 < n) {
    ...
    public abstract void kKamAjA(DesktopAppletBase var1);

    public abstract void kkAMAjA(Graphics var1, int var2, int var3);

    public abstract void nextScriptTimeHex(Graphics var1, int var2, int var3);

    public abstract void kkaMAjA(Triangle var1);
