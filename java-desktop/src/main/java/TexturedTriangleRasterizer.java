 ...
 */
public class TexturedTriangleRasterizer {
    ...
    public TexturedTriangleRasterizer(RgbSurface mmaamma2) {
        this.majAkKA = mmaamma2;
        this.MAjAkKA = this.majAkKA.amAjakK;
        this.mAjAkKA = this.majAkKA.AMAjakK;
    }

    public void MAjakKa(Triangle kmaamma2) {
        boolean bl;
        UvCoord kmajkmk2;
        Vertex mmjakka2;
        float f = 0.0f;
        ...
        Vertex mmjakka5 = kmaamma2.maJAkKa;
        UvCoord kmajkmk3 = kmaamma2.MAJAkKa;
        UvCoord kmajkmk4 = kmaamma2.mAJAkKa;
        UvCoord kmajkmk5 = kmaamma2.MajAkKa;
        if (mmjakka3.onShow > mmjakka4.onShow) {
            mmjakka2 = mmjakka4;
            mmjakka4 = mmjakka3;
            mmjakka3 = mmjakka2;
            kmajkmk2 = kmajkmk4;
        ...
        if (mmjakka4.onShow > mmjakka5.onShow) {
            mmjakka2 = mmjakka5;
            mmjakka5 = mmjakka4;
            mmjakka4 = mmjakka2;
            kmajkmk2 = kmajkmk5;
        ...
        float f4 = mmjakka3.scriptName;
        float f5 = mmjakka3.onShow;
        float f6 = kmajkmk3.akKAMAJ;
        float f7 = kmajkmk3.AKKAMAJ;
        float f8 = mmjakka3.AmajAkk;
        float f9 = mmjakka4.scriptName;
        float f10 = mmjakka4.onShow;
        float f11 = kmajkmk4.akKAMAJ;
        float f12 = kmajkmk4.AKKAMAJ;
        float f13 = mmjakka4.AmajAkk;
        float f14 = mmjakka5.scriptName;
        float f15 = mmjakka5.onShow;
        ...
        if (!bl) {
            ...
            this.MAJaKka = TexturedTriangleRasterizer.MajAkKa((f6 * 65536.0f + f26 * this.majAKka) * 65536.0f);
            this.mAJaKka = TexturedTriangleRasterizer.MajAkKa((f7 * 65536.0f + f26 * this.MAjAKka) * 65536.0f);
            this.MajaKka = TexturedTriangleRasterizer.MajAkKa((f8 * 65536.0f + f26 * this.mAjAKka) * 65536.0f);
            if (n2 < n4) {
                this.MajAKka = f;
                this.maJaKka = (int)(f4 + f26 * this.MajAKka);
            ...
            if (n2 < n4) {
                ...
                this.mAjAKka = this.mAJAKka * this.mAjaKka + this.MAJAKka;
                this.MaJaKka = (int)(f4 + f27 * this.mAJAKka);
                this.MAJaKka = TexturedTriangleRasterizer.MajAkKa((f6 * 65536.0f + f27 * this.majAKka) * 65536.0f);
                this.mAJaKka = TexturedTriangleRasterizer.MajAkKa((f7 * 65536.0f + f27 * this.MAjAKka) * 65536.0f);
                this.MajaKka = TexturedTriangleRasterizer.MajAkKa((f8 * 65536.0f + f27 * this.mAjAKka) * 65536.0f);
                this.mAJAkKa(kmaamma2, n2, n4);
            }
            if (n4 < n6) {
                this.mAJAKka = f3;
                ...
                this.MAJaKka = TexturedTriangleRasterizer.MajAkKa((f11 * 65536.0f + f27 * this.majAKka) * 65536.0f);
                this.mAJaKka = TexturedTriangleRasterizer.MajAkKa((f12 * 65536.0f + f27 * this.MAjAKka) * 65536.0f);
                this.MajaKka = TexturedTriangleRasterizer.MajAkKa((f13 * 65536.0f + f27 * this.mAjAKka) * 65536.0f);
                this.mAJAkKa(kmaamma2, n4, n6);
            }
        }
    }

    void KAMAjKa(Triangle kmaamma2, Vertex mmjakka2, Vertex mmjakka3, Vertex mmjakka4, UvCoord kmajkmk2, UvCoord kmajkmk3, UvCoord kmajkmk4) {
        float f = mmjakka2.scriptName / 65536.0f;
        float f2 = mmjakka2.onShow / 65536.0f;
        float f3 = mmjakka3.scriptName / 65536.0f;
        float f4 = mmjakka3.onShow / 65536.0f;
        float f5 = mmjakka4.scriptName / 65536.0f;
        float f6 = mmjakka4.onShow / 65536.0f;
        ...
        float f8 = 1.0f / f7;
        float f9 = 1.0f / mmjakka2.init;
        float f10 = 1.0f / mmjakka3.init;
        float f11 = 1.0f / mmjakka4.init;
    ...
    void mAJAkKa(Triangle kmaamma2, int n, int n2) {
