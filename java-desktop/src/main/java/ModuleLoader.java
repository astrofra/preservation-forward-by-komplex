...
public class ModuleLoader {
     ...
     */
    public static ModuleSong KAMAJAK(byte[] byArray) {
        if (ModuleLoader.KaMAJAK(byArray)) {
            return ModuleLoader.kaMAJAK(byArray);
        }
        if (ModuleLoader.kAMAJAK(byArray)) {
            return ModuleLoader.KamAJAK(byArray);
        }
        try {
            ...
            do {
                ...
                if (!ModuleLoader.KaMAJAK(byArray2)) continue;
                return ModuleLoader.kaMAJAK(byArray2);
            } while (!ModuleLoader.kAMAJAK(byArray2));
            return ModuleLoader.KamAJAK(byArray2);
        }
