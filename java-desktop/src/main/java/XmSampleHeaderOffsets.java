...
final class XmSampleHeaderOffsets {
    ...
    final static int majaKKA = 12;
    final static int MAjaKKA = 13;
    final static int mAjaKKA = 14;
    final static int MaJAKKA = 15;
    final static int maJAKKA = 16;
    final static int MAJAKKA = 17;
