...
public final class RgbSurface
extends SoftwareImageSurface {
    public int[] MaJakKa;
    public int[] maJakKa;
    public int[] MAJakKa;
    public int[] mAJakKa;
    ...
    public RgbSurface(int n, int n2, int[] nArray) {
        this(n, n2, 1, false);
        this.AmaJakK(nArray);
    }

    public RgbSurface(int n, int n2, int n3, boolean bl) {
        super(n, n2);
        if (n3 == 1) {
    ...
    public final void AMAJAKK(RgbSurface mmaamma2, int n, int n2, RgbSurface mmaamma3, int n3, int n4, int n5, int n6, int n7, int n8, double d) {
        if (d < 0.0) {
            d = 0.0;
        }
        if (d > 1.0) {
    ...
    public final void aMaJakK(RgbSurface mmaamma2, int n, int n2, RgbSurface mmaamma3, int n3, int n4, int n5, int n6, int n7, int n8, double d, double d2) {
        if (d < 0.0) {
            d = 0.0;
        }
        if (d > 1.0) {
    ...
    public void aMAJakK(RgbSurface mmaamma2, int n, int n2) {
        this.aMAjakK(mmaamma2, n, n2, 0, 0, mmaamma2.amAjakK, mmaamma2.AMAjakK);
    }

    public void aMAjakK(RgbSurface mmaamma2, int n, int n2, int n3, int n4, int n5, int n6) {
        if (n < 0) {
            n5 += n;
            n3 -= n;
            n = 0;
    ...
    public void AMajakK(IndexedSurface kmajkka2) {
        int n = this.amAjakK * this.AMAjakK;
        int[] nArray = this.MAJakKa;
    ...
    public void AmAJakK(RgbSurface mmaamma2, float f, float f2, float f3, float f4) {
        int n = (int)f;
        int n2 = (int)f2;
        int n3 = (int)f3;
        int n4 = (int)f4;
