...
printf '[1/7] Configure CMake\n'
cmake -S cpp-offline -B "$BUILD_DIR"

printf '[2/7] Build exporter\n'
...
printf '[3/7] Export intro segment\n'
...
printf '[4/7] Export saari segment\n'
...
printf '[5/7] Export kukot segment\n'
...
printf '[6/7] Merge current full output\n'
...
printf '[7/7] Mux master and h264 copies\n'
