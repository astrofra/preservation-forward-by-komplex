...
printf '[1/9] Configure CMake\n'
cmake -S cpp-offline -B "$BUILD_DIR"

printf '[2/9] Build exporter\n'
...
printf '[3/9] Export intro segment\n'
...
printf '[4/9] Export saari segment\n'
...
printf '[5/9] Export kukot segment\n'
...
printf '[6/9] Export maku segment\n'
...
printf '[7/9] Export watercube segment\n'
...
printf '[8/9] Merge current full output\n'
...
printf '[9/9] Mux master and h264 copies\n'
