...
if not defined SAARI_FRAMES set "SAARI_FRAMES=1600"
if not defined SAARI_FRAMES_PER_ROW set "SAARI_FRAMES_PER_ROW=1"
...
echo         frames=%SAARI_FRAMES% frames_per_row=%SAARI_FRAMES_PER_ROW%
"%BUILD_DIR%\%CONFIG%\forward-export.exe" ^
  --sequence saari ^
  --output "%SAARI_OUTPUT%" ^
  --frames %SAARI_FRAMES% ^
