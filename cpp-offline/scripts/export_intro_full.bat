...
set "BUILD_DIR=cpp-offline\build"
set "CONFIG=Release"
set "OUTPUT_DIR=cpp-offline\output-intro-full"
set "SEQUENCE=intro"
set "INTRO_FRAMES_PER_ROW=6"
set "INTRO_ROWS_PER_ORDER=64"
set "INTRO_END_POSITION=0x1024"
set "POST_ROLL_FRAMES=12"
